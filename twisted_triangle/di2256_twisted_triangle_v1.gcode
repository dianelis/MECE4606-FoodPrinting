...
; --- Layer 1 (Z=9.0mm, step 1 rep 1/2) ---
...
; --- Layer 2 (Z=11.0mm, step 1 rep 2/2) ---
...
; --- Layer 3 (Z=13.0mm, step 2 rep 1/2) ---
...
; --- Layer 4 (Z=15.0mm, step 2 rep 2/2) ---
...
; --- Layer 5 (Z=17.0mm, step 3 rep 1/2) ---
...
; --- Layer 6 (Z=19.0mm, step 3 rep 2/2) ---
...
; --- Layer 7 (Z=21.0mm, step 4 rep 1/2) ---
...
; --- Layer 8 (Z=23.0mm, step 4 rep 2/2) ---
...
; --- Layer 9 (Z=25.0mm, step 5 rep 1/2) ---
...
; --- Layer 10 (Z=27.0mm, step 5 rep 2/2) ---
...
; --- Layer 11 (Z=29.0mm, step 6 rep 1/2) ---
G1 Z30.00 F600   ; Z-hop
G1 X101.553 Y105.796 F1200   ; Travel to start
G1 Z29.00 F300   ; Lower to layer height
...
; --- Layer 12 (Z=31.0mm, step 6 rep 2/2) ---
G1 Z32.00 F600   ; Z-hop
G1 X101.553 Y105.796 F1200   ; Travel to start
G1 Z31.00 F300   ; Lower to layer height
...
; === FINISH ===
G1 Z51.0 F600      ; Raise nozzle clear
