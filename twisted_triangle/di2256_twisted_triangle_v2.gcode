...
; --- Layer 1 (Z=3.0mm, step 1 rep 1/2) ---
G1 Z4.00 F600   ; Z-hop
...
; --- Layer 2 (Z=5.0mm, step 1 rep 2/2) ---
G1 Z6.00 F600   ; Z-hop
G1 X120.000 Y100.000 F1200   ; Travel to start
...
; --- Layer 3 (Z=7.0mm, step 2 rep 1/2) ---
G1 Z8.00 F600   ; Z-hop
...
; --- Layer 4 (Z=9.0mm, step 2 rep 2/2) ---
...
; --- Layer 5 (Z=11.0mm, step 3 rep 1/2) ---
...
; --- Layer 6 (Z=13.0mm, step 3 rep 2/2) ---
...
; --- Layer 7 (Z=15.0mm, step 4 rep 1/2) ---
...
; --- Layer 8 (Z=17.0mm, step 4 rep 2/2) ---
...
; --- Layer 9 (Z=19.0mm, step 5 rep 1/2) ---
...
; --- Layer 10 (Z=21.0mm, step 5 rep 2/2) ---
...
; --- Layer 11 (Z=23.0mm, step 6 rep 1/2) ---
...
; --- Layer 12 (Z=25.0mm, step 6 rep 2/2) ---
...
; === FINISH ===
G1 Z45.0 F600      ; Raise nozzle clear
